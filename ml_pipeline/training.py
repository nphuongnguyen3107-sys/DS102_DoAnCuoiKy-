...
def build_lr_pipeline(params: dict) -> ImbPipeline:
    steps = [
        ("imputer", SimpleImputer(strategy="median")),
...
def train_all_models(X_train, y_train, n_trials: int = N_TRIALS):
    ...
    for name, objective in [
        ...
        smote = study.best_params.get("smote_strategy", "N/A")
        k_feats = study.best_params.get("k_features", "N/A")
    ...
    cfg_lr = best_configs["LogisticRegression"]
