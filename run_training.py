...
def main():
    ...
    # 3. Lấy mô hình XGBoost Pipeline và ngưỡng tối ưu được Optuna/OOF sinh ra động
    xgb_pipeline, _, threshold = results["xgb"]
    features = X_train.columns.tolist()

    # 4. Lưu mô hình xuống file .joblib (kèm theo ngưỡng động đã tối ưu)
    ...
    # 6. Gọi hàm dùng chung trong reporting để sinh báo cáo training_report.md
    print("4. Đang sinh báo cáo huấn luyện tự động...")
